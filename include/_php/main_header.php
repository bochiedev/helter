...
<a href="index.php" class="standard-logo" data-dark-logo="images/logo-dark.png"><h2>BropenSpace</h2></a>

<a href="index.php" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><h2>BropenSpace</h2></a>
...
<a href="checkout.php" class="button  button-small nomargin fright" style="color:#fff;">View Cart</a>
</div>
</div>
</div>
